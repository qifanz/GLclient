...
MFCApplication1Dlg.h, MFCApplication1Dlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CMFCApplication1Dlg. Cette classe définit le comportement de la boîte de dialogue principale de votre application. Le modèle de la boîte de dialogue se trouve dans MFCApplication1.rc, qui peut être modifié dans Microsoft Visual C++.
